<template>
  <div class="profile-page">
    ...
    <div class="bio-section content-area">
      <h3>自我介绍</h3>
      <button class="edit-btn" @click="openEditBio">修改自我介绍</button>
      <p>{{ user.bio }}</p>
    </div>
    ...
    <!-- 编辑自我介绍弹窗 -->
    <el-dialog title="修改自我介绍" :visible.sync="showEditBioPopup" width="30%">
      <el-form>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="showEditBioPopup = false">取消</el-button>
        <el-button type="primary" @click="confirmEditBio">确定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      showEditBioPopup: false, // 控制编辑自我介绍弹窗显示
      showBots: false,
      showRecharge: false,
      showBotPopup: false,
